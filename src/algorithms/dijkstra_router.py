"""
src/algorithms/dijkstra_router.py
──────────────────────────────────
Time-Dependent Dijkstra Navigation Engine.
Single Responsibility: pathfinding logic only.
...
class DijkstraRouter:
    """
    Time-Dependent Shortest Path Engine using Dijkstra's Algorithm.
    Accepts a fully-loaded Graph instance.
    Uses WeightEngine for BPR-formula weights and memoization.
    """
