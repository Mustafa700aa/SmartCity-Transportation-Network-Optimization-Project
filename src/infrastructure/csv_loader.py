"""
src/infrastructure/csv_loader.py
I/O layer: reads CSV files and hydrates a Graph object.
Single Responsibility: file parsing and graph population only.
Replaces the former Graph.load() classmethod.
"""
...
def load_cairo_graph(data_dir) -> Graph:
    """
    Read all 8 CSV files from data_dir and return a fully-populated Graph.
    Replaces the former Graph.load(folder) classmethod.
    """
    g = Graph()
